...
chances_1=chances_2= int(input('Enter the number of balls'))
no_of_chances_1= 0
your_runs= 0
...
if comp_runs < your_runs:
    print ("\nYou won the Game.\n\nYour Total Runs= ",your_runs,"  [Bowls taken: ",no_of_chances_1+1,"]","\nComputer Total Runs= ",comp_runs,"  [Bowls Taken: ",no_of_chances_2+1,"]\n")
